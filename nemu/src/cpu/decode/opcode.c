...
/* 0x00 - 0x03*/	inv, add_r2rm_v, add_rm2r_b, inv,
...
/* 0x14 - 0x17*/	adc_i2al_b, inv, inv, inv,
...
/* 0x48 - 0x4b*/	dec_eax_v, inv, inv, inv,
/* 0x4c - 0x4f*/	inv, dec_ebp_v, inv, inv,
...
/* 0x5c - 0x5f*/	inv, pop_ebp_v, pop_esi_v, pop_edi_v,
...
/* 0x74 - 0x77*/	je_b, jne_b, jbe_b, inv,
...
/* 0xa8 - 0xab*/	test_i2al_b, test_i2eax_v, stos_b, inv,
...
/* 0xc0 - 0xc3*/	group_2_b, group_2_v, ret_i_v, ret_v,
...
/* 0xe8 - 0xeb*/	call_rel_v, jmp_rel_v, inv, jmp_rel_b,
...
{add_i2rm_b, inv, inv, inv, inv, inv, inv, cmp_i2rm_b};
...
{test_i2rm_b, inv, inv, inv, mul_rm2a_b, imul_rm2a_b, inv, inv};

/* 0xf7 */
instr_func group_3_v_entry[8] =
{test_i2rm_v, inv, not_rm_v, inv, mul_rm2a_v, imul_rm2a_v, idiv_rm2a_b, idiv_rm2a_v};
